    ...
    <main className="mx-auto max-w-[1120px] px-8 py-10">
      <div className="flex items-end justify-between">
        <div>
          ...
          <h1 className="mt-2 font-display text-[32px] font-bold text-white">{group.name}</h1>
        </div>
            ...
            <div className="card divide-y divide-white/[0.04] overflow-hidden">
              {(members ?? []).map((m) => (
                <div key={m.user_id} className="flex items-center justify-between px-5 py-4">
                  <div>
                    <p className="text-[14px] font-medium text-ink/90">
                  ...
                  <span className="font-display text-[14px] font-bold text-primary">{m.ownership_pct}%</span>
                </div>
              ))}
            </div>
          </section>
              ...
              {expenses.map((e) => {
                ...
                return (
                  <div key={e.id} className="flex items-center justify-between px-5 py-4">
                    ...
                    <div className="ml-4 text-right shrink-0 flex items-center gap-4">
