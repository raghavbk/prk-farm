    ...
    <main className="mx-auto max-w-[1120px] px-8 py-10">
      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <h1 className="mt-1 font-display text-[32px] font-bold text-white leading-tight">
            Hi, {firstName}
          </h1>
        </div>
      ...
      {/* Groups + Activity in 2-column layout */}
      <div className="mt-10 grid gap-8 lg:grid-cols-5">
        {/* Groups — 3 cols */}
        <section className="lg:col-span-3">
          <div className="flex items-center justify-between mb-5">
            <h2 className="font-display text-[15px] font-semibold text-ink/70">Your Groups</h2>
          ...
          {!groups || groups.length === 0 ? (
            <div className="card p-12 text-center">
              ...
              <p className="font-display text-[15px] font-semibold text-ink/70">No groups yet</p>
              <p className="mt-2 text-[13px] text-ink-faint max-w-[240px] mx-auto">Create your first group to start splitting expenses with your farm circle</p>
        ...
        <section className="lg:col-span-2">
          <h2 className="font-display text-[15px] font-semibold text-ink/70 mb-5">Recent Activity</h2>
