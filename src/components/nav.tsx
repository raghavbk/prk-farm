      ...
      <div className="mx-auto flex h-16 max-w-[1120px] items-center justify-between px-8">
        <div className="flex items-center gap-5">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="h-8 w-8 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/15 transition-colors">
              <span className="font-display text-sm font-bold text-primary">F</span>
            </div>
            <span className="font-display text-[15px] font-semibold text-ink/90">FarmLedger</span>
          </Link>
